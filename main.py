...
class Application:
    ...
    def __init__(self, cameraIndex = 0, windowTitle = "Video", stopKey = "q", capResolution = {"width":1024, "height":768}):
        self.video = cv2.VideoCapture(cameraIndex)
        self.target = cv2.VideoWriter('output.avi', -1, 20.0, (cv2.CAP_PROP_FRAME_WIDTH,cv2.CAP_PROP_FRAME_HEIGHT))
